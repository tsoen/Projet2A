...
public class ChildDAO extends DAOBase {
	...
	public void addChild(Child child) {
        ...
        values.put(CLASSROOM_ID, child.getClassroomId());
		
        this.database.insert(TABLE_NAME, null, values);
    }
    
	public Child getChild(long id) {
		Cursor cursor =  this.database.query(TABLE_NAME, new String[] { ID, NAME, FIRSTNAME, CLASSROOM_ID },
		...
		Child child = new Child("", cursor.getString(1), cursor.getString(2),
